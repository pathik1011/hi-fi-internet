...
if (!class_exists('ElementorModal\Widgets\GT3_Elementor_UnlimitedCharts')) {
	class GT3_Elementor_UnlimitedCharts {
		...
		public function enqueue_scripts(){
			...
			// JS
			wp_register_script('chart', plugins_url('/assets/js/Chart.min.js', __FILE__), array( 'jquery' ), null, true);
		...
		public function frontend_after_enqueue_scripts(){
			wp_enqueue_script('gt3-unlimited-chart-frontend', plugins_url('/assets/js/frontend.js', __FILE__), array('chart'), $this::version, true);
		}
