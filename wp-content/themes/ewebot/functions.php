...
$gt3_enable_wpda_builder = gt3_option("enable_replace_content_wpda");
$gt3_enable_wpda_builder = (isset($gt3_enable_wpda_builder) && $gt3_enable_wpda_builder == "1") ? true : false;

$gt3_enable_wpda_builder = true;
define('GT3_DISABLED_BUILDER', $gt3_enable_wpda_builder);
...
if (!function_exists('gt3_get_pf_type_output')) {
    function gt3_get_pf_type_output($pf, $width, $height, $featured_image, $cols = false){
	    ...
	    $featured_standard = '<div class="blog_post_media">'.$post_animate_start.'<img '.$gt3_featured_image_url_srcset.' alt="'.esc_attr($alt_text).'" />'.$post_animate_end.'</div>';
                                        ...
                                        switch ($key) {
                                            ...
                                            case 'login':
	                                            ...
	                                            if ( is_user_logged_in() ) {
		                                            ...
		                                            echo '<p>' . esc_html__( 'login / register', 'ewebot' ) . '</p>';
	                                            }
	                                            echo '</div>';
                                                break;
                                            case 'cart':
...
if (!function_exists('gt3_footer_area')) {
    function gt3_footer_area(){
        ...
        $pre_footer_text_color = gt3_option_compare('pre_footer_text_color','mb_pre_footer_switch','1','mb_footer_switch','yes');
	    ...
	    $pre_footer_cont_style .= !empty($pre_footer_text_color) ? ' color:'.esc_attr($pre_footer_text_color).';' : '';
...
if (!function_exists('gt3_get_default_footer')) {
	function gt3_get_default_footer(){
		...
		echo '<footer class="main_footer fadeOnLoad clearfix gt3_default_footer" id="footer"><div class="copyright align-center"><div class="container"><div class="row"><div class="span12"><p>' . esc_html__('Footer Area', 'ewebot') . '</p></div></div></div></div></footer>';
	}
}
