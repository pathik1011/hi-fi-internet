...
$options = array(
	...
	array(
		...
		'type'          => 'color',
		'title'         => __( 'Active Menu Item Marker Color', 'ewebot' ),
		'subtitle'      => __( 'Set the active menu item marker color', 'ewebot' ),
		'default'       => '#ffffff',
		'transparent'   => false,
    ...
    array(
        'id'            => 'sub_menu_color',
        'type'          => 'color',
        'title'         => __( 'Sub Menu Text Color', 'ewebot' ),
        'subtitle'      => __( 'Set the header text color for sub menu', 'ewebot' ),
        'default'       => '#3b3663',
        'transparent'   => false,
    ),
    array(
        ...
        'type'          => 'color',
        'title'         => __( 'Sub Menu Text Color on Hover and Current', 'ewebot' ),
        'subtitle'      => __( 'Set the header text color for sub menu on hover and Current menu', 'ewebot' ),
        'default'       => '#f47514',
        'transparent'   => false,
    ),
    array(
...
if (defined('WPDA_PRO_HEADER_BUILDER__FILE') && GT3_DISABLED_BUILDER) {
